...
rubyTick = 0; //For animations
rubies = 0; // Amount of rubies/gems

gameOverTick = 0; // For the game over animation
...
{
	x = global.checkpoint.x;
	y = global.checkpoint.y;
}

//Player States
global.PLAYERSTATEFREE = 1;
global.ATTACKSLASH = 2;
global.ATTACKCOMBO = 3;

enum playerStates // Player states as enum values
{
	hurt,
	playerstatefree,
	attackslash,
...
//current state for player
state = global.PLAYERSTATEFREE;

//Reference for ds_list - 
//https://www.reddit.com/r/gamemaker/comments/6i6wzq/using_ds_lists_to_handle_hits_for_multiple/
//apparently this is the most effective way to prevent one single hit from instantly killing an enemy,
//by tracking/storing how many hits so far
//as I was having aan issue with one hit instantly killing an enemy
